...
print(str(closest_sum_pair(a1, a2, a_target)) + " ... " + str(a_target))
print(str(closest_sum_pair(b1, b2, b_target)) + " ... " + str(b_target))
print(str(closest_sum_pair(c1, c2, c_target)) + " ... " + str(c_target))
print(str(closest_sum_pair(d1, d2, d_target)) + " ... " + str(d_target))